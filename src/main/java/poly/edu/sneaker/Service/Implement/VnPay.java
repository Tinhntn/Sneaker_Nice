...
public class VnPay {
    public String createOrder(int total, String orderInfor, String urlReturn,HttpServletRequest request) throws UnsupportedEncodingException {
        ...
        vnp_Params.put("vnp_Amount", String.valueOf(amount)); // ✅ Sử dụng total thay vì số cố định
...
//        }
        ...
        vnp_Params.put("vnp_ReturnUrl", urlReturn+VnPayConfig.vnp_Returnurl ); // ✅ Encode URL return
        ...
        // 1. Lấy danh sách tham số (trừ vnp_SecureHash)
